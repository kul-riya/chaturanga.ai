...
int promoted_pieces[] = {
    ['\0'] = ' ',  // Add a default for no promotion
    [Q] = 'q',    [R] = 'r', [B] = 'b', [N] = 'n',
    [q] = 'q',    [r] = 'r', [b] = 'b', [n] = 'n',
};
...
int castling_rights[128] = {
    7,  15, 15, 15, 3,  15, 15, 11, o,  o,  o,  o,  o,  o,  o,  o,  15, 15, 15,
    15, 15, 15, 15, 15, o,  o,  o,  o,  o,  o,  o,  o,  15, 15, 15, 15, 15, 15,
    15, 15, o,  o,  o,  o,  o,  o,  o,  o,  15, 15, 15, 15, 15, 15, 15, 15, o,
    o,  o,  o,  o,  o,  o,  o,  15, 15, 15, 15, 15, 15, 15, 15, o,  o,  o,  o,
    o,  o,  o,  o,  15, 15, 15, 15, 15, 15, 15, 15, o,  o,  o,  o,  o,  o,  o,
    o,  15, 15, 15, 15, 15, 15, 15, 15, o,  o,  o,  o,  o,  o,  o,  o,  13, 15,
    15, 15, 12, 15, 15, 14, o,  o,  o,  o,  o,  o,  o,  o};

// positional scores
int positional_score[128] = {
    0,  0, 5,  0, -5, 0,  5,  0,  o,  o,  o,  o,  o,  o,  o,  o,  5,  5,  0,
    0,  0, 0,  5, 5,  o,  o,  o,  o,  o,  o,  o,  o,  5,  10, 15, 20, 20, 15,
    10, 5, o,  o, o,  o,  o,  o,  o,  o,  5,  10, 20, 30, 30, 20, 10, 5,  o,
    o,  o, o,  o, o,  o,  o,  5,  10, 20, 30, 30, 20, 10, 5,  o,  o,  o,  o,
    o,  o, o,  o, 5,  10, 15, 20, 20, 15, 10, 5,  o,  o,  o,  o,  o,  o,  o,
    o,  5, 5,  0, 0,  0,  0,  5,  5,  o,  o,  o,  o,  o,  o,  o,  o,  0,  0,
    5,  0, -5, 0, 5,  0,  o,  o,  o,  o,  o,  o,  o,  o};

// chess board representation
int board[128] = {r, n, b, q, k, b, n, r, o, o, o, o, o, o, o, o, p, p, p,
                  p, p, p, p, p, o, o, o, o, o, o, o, o, e, e, e, e, e, e,
                  e, e, o, o, o, o, o, o, o, o, e, e, e, e, e, e, e, e, o,
                  o, o, o, o, o, o, o, e, e, e, e, e, e, e, e, o, o, o, o,
                  o, o, o, o, e, e, e, e, e, e, e, e, o, o, o, o, o, o, o,
                  o, P, P, P, P, P, P, P, P, o, o, o, o, o, o, o, o, R, N,
                  B, Q, K, B, N, R, o, o, o, o, o, o, o, o};
...
#define encode_move(source, target, piece, capture, pawn, enpassant, castling) \
  ((source) | (target << 7) | (piece << 14) | (capture << 18) | (pawn << 19) | \
   (enpassant << 20) | (castling << 21))
...
char *square_to_coords[] = {
    ...
    "m8", "n8", "o8", "p8", "a7", "b7", "c7", "d7", "e7", "f7", "g7", "h7",
    "i7", "j7", "k7", "l7", "m7", "n7", "o7", "p7", "a6", "b6", "c6", "d6",
    "e6", "f6", "g6", "h6", "i6", "j6", "k6", "l6", "m6", "n6", "o6", "p6",
    "a5", "b5", "c5", "d5", "e5", "f5", "g5", "h5", "i5", "j5", "k5", "l5",
    "m5", "n5", "o5", "p5", "a4", "b4", "c4", "d4", "e4", "f4", "g4", "h4",
    "i4", "j4", "k4", "l4", "m4", "n4", "o4", "p4", "a3", "b3", "c3", "d3",
    "e3", "f3", "g3", "h3", "i3", "j3", "k3", "l3", "m3", "n3", "o3", "p3",
    "a2", "b2", "c2", "d2", "e2", "f2", "g2", "h2", "i2", "j2", "k2", "l2",
    "m2", "n2", "o2", "p2", "a1", "b1", "c1", "d1", "e1", "f1", "g1", "h1",
...
void print_move_list(moves *move_list) {
  ...
  for (int index = 0; index < move_list->count; index++) {
    ...
    printf("%c    ",
           get_move_piece(move) ? promoted_pieces[get_move_piece(move)] : ' ');
    printf("%d        %d        %d        %d\n", get_move_capture(move),
           get_move_pawn(move), get_move_enpassant(move),
...
int is_square_attacked(int square, int side) {
  ...
  for (int index = 0; index < 8; index++) {
    ...
    if (!(target_square & 0x88)) {
      if (!side ? target_piece == N : target_piece == n) return 1;
    }
  }
  ...
  for (int index = 0; index < 8; index++) {
    ...
    if (!(target_square & 0x88)) {
      ...
      if (!side ? target_piece == K : target_piece == k) return 1;
    }
  }
  ...
  for (int index = 0; index < 4; index++) {
    ...
    while (!(target_square & 0x88)) {
      ...
      if (!side ? (target_piece == B || target_piece == Q)
  ...
  for (int index = 0; index < 4; index++) {
    ...
    while (!(target_square & 0x88)) {
      ...
      // if target piece is either white or black bishop or queen
      if (!side ? (target_piece == R || target_piece == Q)
...
void generate_moves(moves *move_list) {
  ...
  for (int square = 0; square < 128; square++) {
    ...
    if (!(square & 0x88)) {
        ...
        if (board[square] == P) {
          ...
          if (!(to_square & 0x88) && !board[to_square]) {
            ...
            if (square >= a7 && square <= h7) {
              add_move(move_list,
                       encode_move(square, to_square, Q, 0, 0, 0, 0));
              add_move(move_list,
                       encode_move(square, to_square, R, 0, 0, 0, 0));
              add_move(move_list,
                       encode_move(square, to_square, B, 0, 0, 0, 0));
              add_move(move_list,
                       encode_move(square, to_square, N, 0, 0, 0, 0));
            }

            else {
              // one square ahead pawn move
              add_move(move_list,
                       encode_move(square, to_square, 0, 0, 0, 0, 0));

              // two squares ahead pawn move
              if ((square >= a2 && square <= h2) && !board[square - 32])
                add_move(move_list,
                         encode_move(square, square - 32, 0, 0, 1, 0, 0));
            }
          }
            ...
            if (pawn_offset < 0) {
              ...
              if (!(to_square & 0x88)) {
                ...
                if ((square >= a7 && square <= h7) &&
                  ...
                  add_move(move_list,
                           encode_move(square, to_square, Q, 1, 0, 0, 0));
                  add_move(move_list,
                           encode_move(square, to_square, R, 1, 0, 0, 0));
                  add_move(move_list,
                           encode_move(square, to_square, B, 1, 0, 0, 0));
                  add_move(move_list,
                           encode_move(square, to_square, N, 1, 0, 0, 0));
                }
                  ...
                  if (board[to_square] >= 7 && board[to_square] <= 12)
                    add_move(move_list,
                             encode_move(square, to_square, 0, 1, 0, 0, 0));

                  // enpassant capture
                  if (to_square == enpassant)
                    add_move(move_list,
                             encode_move(square, to_square, 0, 1, 0, 1, 0));
                }
              }
            }
          }
      ...
      // bishop & queen moves
      if (!side ? (board[square] == B) || (board[square] == Q)
        ...
        for (int index = 0; index < 4; index++) {
          ...
          while (!(to_square & 0x88)) {
            ...
            // if hits own piece
            if (!side ? (piece >= 1 && piece <= 6)
                      : ((piece >= 7 && piece <= 12)))
              break;

            // if hits opponent's piece
            if (!side ? (piece >= 7 && piece <= 12)
                      : ((piece >= 1 && piece <= 6))) {
              add_move(move_list,
                       encode_move(square, to_square, 0, 1, 0, 0, 0));
              break;
      ...
      // rook & queen moves
      if (!side ? (board[square] == R) || (board[square] == Q)
...
int make_move(int move, int capture_flag) {
  ...
  if (capture_flag == all_moves) {
    ...
    if (is_square_attacked(
            !side ? king_square[side ^ 1] : king_square[side ^ 1], side)) {
...
int evaluate_position() {
  ...
  for (int square = 0; square < 128; square++) {
    ...
    if (!(square & 0x88)) {
      ...
      // piece is white
      if (piece >= 1 && piece <= 6) score += positional_score[square];
...
int quiescence_search(int alpha, int beta) {
  ...
  if (ply > 5) return evaluate_position();
...
int search_position(int alpha, int beta, int depth) {
  ...
  for (int move_count = 0; move_count < move_list->count; move_count++) {
    ...
    if (score > alpha) {
      ...
      if (!ply) best_so_far = move_list->moves[move_count];
    }
  }
  ...
  if (!legal_moves) {
    ...
    if (is_square_attacked(king_square[side], side ^ 1)) return -49000 + ply;
  ...
  if (alpha != old_alpha) best_move = best_so_far;
...
int parse_move(char *move_str) {
  ...
  for (int count = 0; count < move_list->count; count++) {
    ...
    if (get_move_source(move) == parse_from &&
        get_move_target(move) == parse_to) {
      // init promoted piece
      prom_piece = get_move_piece(move);

      // if promoted piece is present compare it with promoted piece from user
      // input
      if (prom_piece) {
  ...
  while (1) {
    ...
    // parse GUI input moves after initial position
      ...
      while (*moves_part) {
        ...
        make_move(parse_move(moves_part), all_moves);

        // go to next move
        while (*moves_part && *moves_part != ' ') moves_part++;
        if (*moves_part == ' ') moves_part++;
      }

      // print the board after moves are made
      print_board();
    }
    ...
    // init board from FEN
      ...
      // use strstr to find moves
      char *moves_part = strstr(line, "moves");

      // if moves are present
      if (moves_part != NULL) {
        // terminate fen string
        *(moves_part - 1) = '\0';
    ...
    // parse fixed depth "go" command
      ...
      // output best move
      if (best_move) printf("info score cp %d depth %d\n", score, depth);
    ...
    // use fixed depth 3 for all the other modes but fixed depth, e.g. in blitz
    // mode
      ...
      // output best move
      if (best_move) printf("info score cp %d depth 4\n", score);
      printf("bestmove %s%s%c\n", square_to_coords[get_move_source(best_move)],
             square_to_coords[get_move_target(best_move)],
             promoted_pieces[get_move_piece(best_move)]);
    }
